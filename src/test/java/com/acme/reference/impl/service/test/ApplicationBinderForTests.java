...
import com.acme.reference.impl.framework.EMFFactory;
...
public class ApplicationBinderForTests extends AbstractBinder {
    ...
    protected void configure() {
       ...
       bind(InMemoryDBBenchmarkClientDAO.class).qualifiedBy(new InMemoryDAO_()).to(new TypeLiteral<BenchmarkAggregatorDAOI<BenchmarkClient>>() {}).in(PerLookup.class);
